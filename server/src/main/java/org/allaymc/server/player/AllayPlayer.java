...
public class AllayPlayer implements Player {
    ...
    protected ScoreInfo toNetworkScoreInfo(ScoreboardLine line) {
        ...
        switch (line.getScorer()) {
            ...
            case PlayerScorer scorer -> {
                // GearsMC fork: PlayerScorer uuid degil xuid tutar (oyuncu adini
                // degistirse bile skorlari kaybolmasin diye) ve oyuncuyu kendisi cozer.
                var player = scorer.getPlayer();
                if (player == null) {
                    return null;
                }
    ...
    public void spawnEntityPlayer() {
        ...
        if (logOffDimension == null) {
            ...
            // GearsMC fork: depolama uuid ile degil xuid ile anahtarlanir.
