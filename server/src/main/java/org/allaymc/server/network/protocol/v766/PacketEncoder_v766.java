...
public class PacketEncoder_v766 extends PacketEncoder {
     ...
     *
     * <p>Her satir {uuid, surum} ciftidir. Education bloklarinin dogru gorunmesi icin
     * kaynak paketi yigininda listelenmeleri gerekir; icerikleri sunucudan gonderilmez,
     * istemci zaten sahiptir. Farkli istemci surumleri farkli uuid tasidigi icin
     * hepsi birden listelenir.</p>
     */
    protected static final String[][] CHEMISTRY_RESOURCE_PACKS = {
    ...
    public ResourcePackStackPacket encodeResourcePackStack() {
        ...
        // GearsMC fork: istemcinin kendi icinde gomulu kimya paketlerini de yigina ekler,
        // yoksa Education bloklari dogru gorunmez. Bu kayitlar sunucudan gonderilmez;
        // sadece istemciye "sendeki paketi kullan" demek icin listelenir.
    ...
    public Collection<BedrockPacket> encodeParticle(
        ...
        switch (particle) {
            ...
            case SimpleParticle.GUARDIAN_CURSE ->
    ...
    private static void addTypeSpecificMetadata(Entity entity, EntityDataMap metadata) {
        switch (entity) {
            ...
            case EntityWeaponStanceComponent armed -> addWeaponStanceMetadata(armed, metadata);
