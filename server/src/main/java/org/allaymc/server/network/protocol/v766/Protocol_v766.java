...
public abstract class Protocol_v766 extends Protocol {
    ...
    protected void registerProcessors(PacketProcessorRegistry registry) {
        ...
        // GearsMC fork: istemci paketleri dogruladiktan sonra bu paketi gonderiyor;
        // karsilayan bir islemci olmazsa oyuncu kaynak paketi ekraninda takili kalir.
        registry.register(ClientState.LOGGED_IN, BedrockPacketType.RESOURCE_PACKS_READY_FOR_VALIDATION, ResourcePacksReadyForValidationPacketProcessor::new);
